...
const string LEVEL_TEXT_FILE_PATH = "..\\..\\lin.steele\\final\\Level_";
const string SAVE_STATE_TEXT_FILE_PATH = "..\\..\\lin.steele\\final\\SaveState.txt";
const string GAME_TEXT_FILE_PATH = "..\\..\\lin.steele\\final\\ModGameFiles.txt";
const string ENGLISH_TEXT_FILE_PATH = "..\\..\\lin.steele\\final\\English.txt";
const string PIRATE_TEXT_FILE_PATH = "..\\..\\lin.steele\\final\\Pirate.txt";
const string VULCAN_TEXT_FILE_PATH = "..\\..\\lin.steele\\final\\Vulcan.txt";
const string ASSET_PATH_TWO = "..\\..\\lin.steele\\Assets\\";
const string THEME_FILE_PATH = "..\\..\\lin.steele\\Assets\\maintheme.flac";
