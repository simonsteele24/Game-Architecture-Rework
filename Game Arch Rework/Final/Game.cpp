...
void Game::cleanup() 
{
	...
	delete mPlayerRedAnimation;
	delete mPlayerRedJumpAnimation;
	delete mPlayerGreenAnimation;
	delete mPlayerGreenJumpAnimation;
	delete mPlayerDeathAnimation;
	delete mSuperPlayerAnimation;
	delete mSuperPlayerJumpAnimation;
	delete mSuperPlayerRedAnimation;
	delete mSuperPlayerRedJumpAnimation;
	delete mSuperPlayerGreenAnimation;
	delete mSuperPlayerGreenJumpAnimation;
	...
	delete mEndBlockAnimation;
	delete mBackgroundEndImage;

	// Props/Environment
	delete mBigHillAnimation;
	delete mCloudAnimation;
	delete mPipeAnimation;
	delete mSmalllOrangeBoxAnimation;
	delete mTallBlueBoxAnimation;
	delete mLargeGreenBoxAnimation;
	delete mMediumRedBoxAnimation;
	delete mLongGreenBoxAnimation;
	delete mLargeWhiteBoxAnimation;
	delete mLargeRedBoxAnimation;
	delete mLargeBlueBoxAnimation;
	delete mTallGreenBoxAnimation;
	delete mBlueFloatingBoxAnimation;
	delete mGreenFloatingBoxAnimation;
	delete mLargeRedFloatingBoxAnimation;
	delete mSmallRedFloatingBoxAnimation;
	delete mWoodBlockAnimation;
	delete mBushAnimation;
	delete mDonutBushAnimation;
	delete mDonutHillOneAnimation;
	delete mDonutHillTwoAnimation;
	delete mLavaAnimation;
	delete mFireballUpAnimation;
	delete mFireballDownAnimation;
	delete mDeepGrassAnimation;
	delete mGrassAnimation;
	delete mHorizontalPipeAnimation;
	delete mLeftCornerSlopeAnimation;
	delete mRightCornerSlopeAnimation;
	delete mLeftSlopeAnimation;
	delete mRightSlopeAnimation;
	delete mTopSlopeAnimation;
	delete mLeftPlatformAnimation;
	delete mRightPlatformAnimation;
	delete mMiddlePlatformAnimation;
	delete mLargePlatformAnimation;
	delete mPoleAnimation;
	delete mCastleBlockAnimation;

	// Enemies
	delete mGoombaAnimation;
	delete mKoopaAnimation;
	delete mKoopaRightAnimation;
	delete mKoopaShellAnimation;
	delete mKoopaShellSpinAnimation;
	delete mPiranhaAnimation;
	delete mThwompAnimation;
	delete mDryBonesLeftAnimation;
	delete mDryBonesRightAnimation;
	delete mDryBonesDownAnimation;
	delete mBoomBoomDefenseAnimation;
	delete mBoomBoomWalkAnimation;
	delete mBoomBoomJumpAnimation;
	delete mBoomBoomSquishedAnimation;

	// Collectibles
	delete mSuperMushroomAnimation;
	delete mCoinAnimation;
	delete mStarmenAnimation;
